...
export async function POST(request) {
    ...
    try {
        ...
        const createdGroup = await create(state, 'groups')
...
export async function PUT(request) {
    ...
    try {
        ...
        const editedGroup = await findAndUpdate(filter, { $set: state }, 'groups')
        return NextResponse.json(
            {
...
export async function GET() {
    try {
        await dbConnect()
        const groups = await findAll({}, 'groups')
        return NextResponse.json(
            {
                data: groups
            },
...
export async function DELETE(request) {
    ...
    try {
        ...
        await findAndDelete(filter, 'groups')
        return NextResponse.json(
            {
